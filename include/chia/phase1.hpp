				...
				const std::string tmp_dir_2)
{
	...
	DiskSort2 sort_2(32 + kExtraBits, log_num_buckets, prefix + "t2");
	...
	DiskSort4 sort_4(32 + kExtraBits, log_num_buckets, prefix + "t4");
	compute_table<entry_3, entry_4, tmp_entry_x>(
			4, num_threads, &sort_3, &sort_4, &tmp_3);
	
	DiskTable<tmp_entry_x> tmp_4(prefix_2 + "table4.tmp");
	...
	DiskTable<tmp_entry_x> tmp_5(prefix_2 + "table5.tmp");
	DiskSort6 sort_6(32 + kExtraBits, log_num_buckets, prefix + "t6");
